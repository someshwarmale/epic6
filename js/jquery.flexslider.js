(function(a) {
    a.flexslider = function(d, n) {
        ...
        e = {
                ...
                if (l.keyboard && (a(b.containerSelector).length === 1 || l.multipleKeyboard)) {
                    a(document).bind("keyup", function(p) {
                        ...
                        if (!b.animating && (o === 39 || o === 37)) {
                            var q = (o === 39) ? b.getTarget("next") : (o === 37) ? b.getTarget("prev") : !1;
                ...
                setup: function() {
                    ...
                    b.slides.click(function(q) {
                        ...
                        if (!a(l.asNavFor).data("flexslider").animating && !p.hasClass("active")) {
                            ...
                            b.flexAnimate(o, l.pauseOnAction, !1, !0, !0)
                        }
                    })
                }
            },
            ...
            touch: function() {
                var t, r, p, u, x, v, s = !1;
                d.addEventListener("touchstart", q, !1);
                ...
                function q(y) {
                    if (b.animating) {
                        ...
                        if (y.touches.length === 1) {
                            ...
                            d.addEventListener("touchmove", o, !1);
                            d.addEventListener("touchend", w, !1)
                        }
                    }
                }
                ...
                function w(A) {
                    d.removeEventListener("touchmove", o, !1);
                    if (b.animatingTo === b.currentSlide && !s && !(x === null)) {
                        ...
                        if (b.canAdvance(y) && (Number(new Date()) - v < 550 && Math.abs(z) > 50 || Math.abs(z) > u / 2)) {
                            ...
                            if (!f) {
                                b.flexAnimate(b.currentSlide, l.pauseOnAction, !0)
                            }
                        }
                    }
                    d.removeEventListener("touchend", w, !1);
                    t = null;
                    r = null;
                    x = null;
                    p = null
            ...
            sync: function(o) {
                ...
                switch (o) {
                    case "animate":
                        q.flexAnimate(p, l.pauseOnAction, !1, !0);
                        break;
                    case "play":
        ...
        b.canAdvance = function(q, o) {
            ...
            return (o) ? !0 : (k && b.currentItem === b.count - 1 && q === 0 && b.direction === "prev") ? !0 : (k && b.currentItem === 0 && q === b.pagingCount - 1 && b.direction !== "next") ? !1 : (q === b.currentSlide && !k) ? !1 : (l.animationLoop) ? !0 : (b.atEnd && b.currentSlide === 0 && q === p && b.direction !== "next") ? !1 : (b.atEnd && b.currentSlide === p && q === 0 && b.direction === "next") ? !1 : !0
        };
